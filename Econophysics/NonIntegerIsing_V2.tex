...
\title{ Price dynamics via the Langevin-Helmholtz equation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\author{Rafael Morgado}
\email{rafael.morgadosilva@gmail.com }
...
\begin{abstract}
  ...
  The model proposes that the price dynamics of financial assets are not a pure random walk, but a succession of latent (primitive) states
that manifest themselves noisily. Assets are classified by the “signature” of their confinement potentials, where liquidity acts as the damping/diffusion parameter in the system.
